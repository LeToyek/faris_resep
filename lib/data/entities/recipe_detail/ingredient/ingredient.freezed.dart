...
mixin _$Ingredient {
  ...
  List<IngredientItem> get items => throw _privateConstructorUsedError;
...
abstract class $IngredientCopyWith<$Res> {
  ...
  @useResult
  $Res call({String title, List<IngredientItem> items});
}
...
class _$_Ingredient implements _Ingredient {
  const _$_Ingredient(
      {required this.title, required final List<IngredientItem> items})
      : _items = items;
  ...
  @override
  String toString() {
    return 'Ingredient(title: $title, items: $items)';
  }
...
abstract class _Ingredient implements Ingredient {
  const factory _Ingredient(
      ...
      required final List<IngredientItem> items}) = _$_Ingredient;
